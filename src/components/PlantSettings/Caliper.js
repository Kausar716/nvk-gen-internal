    ...
    class Caliper extends Component {
        ...
        onDragEnd = result => {
            ...
            if (destination.droppableId=="delete") {
                ...
                confirmAlert({
                    title: 'Delete Caliper ',
                    message: 'Are you sure want to delete the Caliper ?',
                    buttons: [
                      {
                        label: 'Yes',
                                            ...
                                            >
                                                {this.state.inactive.map((item, index) => (
                                                    <Draggable
                                                        ...
                                                        <div className={this.state.isEditing===false  ? "a" :this.state.selectedID === item.id ? "reasonBackground a" : "a"}><span id={item.id}    >{item.value} ({item.sub_attributeschild[1].value})</span>
