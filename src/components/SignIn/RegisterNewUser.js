  ...
  return (
    <>
      ...
      <div style={{backgroundColor:"white"}}>
             ...
             <p style={{color:"#787d82",fontWeight:"bold",padding:0,margin:0}}>SignUp Request</p>
             ...
             {/* <p style={{textAlign:"center",color:"red"}}>Wrong email and password</p> */}
                ...
                <FormGroup >
                    <Label>
                    <Link to="/" > 
                      <Button className="loginbutton" type="submit" onClick={handleSubmit(onSubmit)} disabled={pristine || submitting}  style={{backgroundColor:"#d07510",border:"1px solid white",marginLeft:22,position:"relative",paddingRight:25, borderBottom:"4px solid #ad4902"}} ><span >Submit</span> <span class='bx bxs-right-arrow-circle' style={{fontSize:"15px",verticalAlign:"middle",position:"absolute",top:11,left:75}}></span></Button>
                    </Link>
                    </Label>
                </FormGroup>
