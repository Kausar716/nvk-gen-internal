...
export class PlantInventorySku extends Component {  
    constructor(){
        super()
        this.state={
            selectedLocationId:"",
...
export default connect(mapStateToProps,{getCategoryList,getLocationList,getAllSupplierAction,getPlantList,getFilterResult})(PlantInventorySku)
