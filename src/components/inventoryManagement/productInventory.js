...
import {getLocationList,getProductCategoryList,getPlantList,getFilterResult,getManufacturerList} from "../../actions/inventoryManagementAction";
                                ...
                                <div class="row mt-3 align-items-center">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        ...
                                        <div class="searchInput">
                                            ...
                                            <input type="text" class="form-control" placeholder="Search" name="" onChange={this.handleFilterChange}/>
                                        </div>
                                        <div class="form-group row mt-2">
                                            <div class="col-md-12">
                                                <div class="form-check form-check-inline">
...
export default connect(mapStateToProps,{getProductCategoryList,getLocationList,getAllSupplierAction,getPlantList,getFilterResult,getManufacturerList})(ProductInventory)
