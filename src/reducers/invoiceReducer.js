...
//
   ...
   customerList:[],
   pageNumber:0,
   customerFilterIds:{name:"",order_id:"",invoice:"",alpha:"All"},
   customerInvoiceBackup:[],
   duplicateData:[],
   activeData:[],
   inactiveData:[],
   radioFilter:"active",
    ...
    case RESET_CUSTOMER_FILEDS:
        return{
            ...
            customerContact:{
              ...
              customerDataById:{name:"",customer_details:"",type:[],address_id:0,contact_id:0,alternative_id:"",alert:"",reason:"",status:1,prospect:0,level:0,dispatch_type:"Delivery" ,
...
////////////////////////////ends here////////////////////////
        ...
        case GET_INVOICE_LIST :
            return{
                ...
                customerInvoiceBackup:  [...action.payload.data.active]     
            }
            ...
            case FILTER_INVOICE_INVENTORY_ACTION:
                let filterIds = state.customerFilterIds
                ...
                let filterData = state.customerInvoiceBackup.filter(product =>{
                    let notFoundCount = 0 
                    // alert("dsa")
                    Object.keys(filterIds).map(id=>{
                        if(filterIds[id] !=="All" && filterIds[id] !==""){
                            ...
                            // }
                            // alert("s")
                            if((id==="alpha" &&product["name"].toLowerCase().charAt(0)===filterIds[id].toLowerCase().charAt(0))){
                                // product["name"].toLowerCase().includes(filterIds[id].toLowerCase())
                            ...
                            else if(((id ==="name" || id ==="order_id"||id ==="invoice"))  && product["name"].toLowerCase().includes(filterIds[id].toLowerCase())){
            ...
            case FILTER_DATA_BY_ALPHA:
                ...
                case RESET_INVOICE_FILEDS:
                    return{
                        ...state,
                        customerFilterIds:{name:"",order_id:"",invoice:"",alpha:"All"},
                        customerList:state.customerInvoiceBackup,
